...
var header = document.getElementById("picked_color_value");
var dropperButton = document.getElementById("dropper");
...
function handleMouseMove(event) {
    if (isDropperActive) {
        ...
        var pixel = ctx.getImageData(offsetX, offsetY, 1, 1).data;
 ...
 */
function displayColorCircle(color, x, y) {
